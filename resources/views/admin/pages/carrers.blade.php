    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card ">
            <div class="card-header d-flex justify-content-between align-items-center border-bottom-1">
                <h5 class="mb-0">All Job Circulars</h5>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addServiceModal">
                    <i class="bi bi-plus-circle"></i> Add New Job Circular
                </button>
            </div>
            <div class="card-body">
        ...
        <div class="modal-content">
            <form id="serviceForm" enctype="multipart/form-data">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fa-solid fa-plus-circle me-2"></i>Add New Job Circular</h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="type" class="form-control" placeholder="Full Time , Part Time, Work From Home" >
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control ckeditor" id="summernote" rows="3"></textarea>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Save Job Circular</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form id="editServiceForm" enctype="multipart/form-data">
            ...
            <div class="modal-header bg-warning text-white">
                <h5 class="modal-title"><i class="fa-solid fa-pen-to-square me-2"></i>Edit Job Circular</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Job Type</label>
                            <input type="text" id="type" name="type" class="form-control" placeholder="Full Time , Part Time, Work From Home" >
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Position</label>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control ckeditor2" id="description" rows="3"></textarea>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-warning">Update Job Circular</button>
            </div>
        </form>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    let table = $('#servicesTable').DataTable({
        ...
        columns: [
            ...
            { data: 'salary', name: 'salary' }, // Salary
            ...
            { data: 'deadline', name: 'deadline' }, // Deadline
...
$(document).ready(function () {
    ...
    $(document).on('click', '.editServiceBtn', function () {
        ...
        $.ajax({
            url: `{{ route('careers.edit', ':id') }}`.replace(':id', id),
            type: 'GET',
            ...
            error: function () {
                toastr.error('Failed to fetch Job Circular details.');
            }
        });
    });
    ...
    $('#editServiceForm').on('submit', function (e) {
        ...
        $.ajax({
            url: `{{ route('careers.update', ':id') }}`.replace(':id', id),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            success: function () {
                ...
                toastr.success('Job Circular updated successfully!');
